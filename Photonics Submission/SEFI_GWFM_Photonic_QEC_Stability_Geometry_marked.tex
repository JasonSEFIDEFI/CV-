...
% === Markup Package for Tracked Changes ===
\usepackage[final]{changes}
\definechangesauthor[name={JD}, color=blue]{JD}
...
\title{
\replaced[id=JD]{Photonic Quantum Error Correction from Geometric Stability Principles in SEFI/GWFM}{Photonic Quantum Error Correction from Geometric Stability Principles in SEFI/GWFM}
}
...
\begin{abstract}
\added[id=JD]{[Insert any abstract edits here.]}
...
\added[id=JD]{[Insert introduction edits here.]}
...
\added[id=JD]{[Insert edits to this subsection here.]}
...
\added[id=JD]{[Insert edits to error-surface section here.]}
...
\added[id=JD]{[Insert edits to SPDC section here.]}
...
\added[id=JD]{[Insert edits to CHSH section here.]}
...
\added[id=JD]{[Insert edits to experimental section here.]}
...
\added[id=JD]{[Insert edits to conclusion here.]}
...
% Bibliography unchanged — add markup only if needed
\bibitem{DuttonSEFI}
