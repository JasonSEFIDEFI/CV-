...
% --- Highlight Banner / Graphical Abstract (Top of Document) ---
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{highlight.jpg}
    \caption*{\textbf{Graphical Overview:} Integrated conceptual mapping linking molecular B-DNA helical geometry, the golden-ratio invariant $\kappa/\tau_g = \pi/\phi$, and fixed-point identity field confinement on $M \times \mathcal{I}$.}
\end{figure}
