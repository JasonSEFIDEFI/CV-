...
The displacement-based warp-field model developed in this work is constructed within the identity-space formalism established in the Single Entity Field Interpretation (SEFI), the Displacement-Entity Field Interpretation (DEFI), and the Geometric Worldline Field Model (GWFM). In this section, we summarize the geometric structure required for the displacement operator, the representation of worldlines, and the constraints necessary to preserve identity-space coherence.
